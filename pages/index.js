        ...
        *:after {
        ...
        @font-face {
          ...
          src: local('Open Sans Regular'), local('OpenSans-Regular'),
            ...
            /* IE6-IE8 */ url('/static/fonts/open-sans-v16-latin-regular.woff2')
              format('woff2'),
        ...
        @font-face {
          ...
          src: local('Montserrat Medium'), local('Montserrat-Medium'),
            ...
            /* IE6-IE8 */ url('/static/fonts/montserrat-v13-latin-500.woff2')
              format('woff2'),
            /* Super Modern Browsers */
              url('/static/fonts/montserrat-v13-latin-500.woff') format('woff'),
            /* Modern Browsers */
        ...
        @font-face {
          ...
          src: local('Montserrat SemiBold'), local('Montserrat-SemiBold'),
            ...
            /* IE6-IE8 */ url('/static/fonts/montserrat-v13-latin-600.woff2')
              format('woff2'),
            /* Super Modern Browsers */
              url('/static/fonts/montserrat-v13-latin-600.woff') format('woff'),
            /* Modern Browsers */
